...
{
    public class RelatorioTemploCentralMovimentoCaixaMissao(RelatorioMovimentoCaixaViewModel ralatorio) : IDocument
    {
            ...
            container.Table(table =>
                {
                    ...
                    table.Header(header =>
                    {
                        ...
                        header.Cell().Border(0.5f).Text("MOVIMENTO DO CAIXA DE MISSÕES").Bold().AlignCenter(); ;
