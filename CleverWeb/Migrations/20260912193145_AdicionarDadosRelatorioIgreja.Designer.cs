...
namespace CleverWeb.Migrations
{
    ...
    [Migration("20260912193145_AdicionarDadosRelatorioIgreja")]
    partial class AdicionarDadosRelatorioIgreja
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleverWeb.Models.Despesa", b =>
                {
                    ...
                    b.Property<bool>("GeradaNoFechamento")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CleverWeb.Models.Tenant", b =>
                {
                    ...
                    b.Property<string>("PastorCongregacional")
                        .IsRequired()
                        .HasColumnType("TEXT");
